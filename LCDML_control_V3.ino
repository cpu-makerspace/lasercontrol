...
// settings
  #define _LCDML_CONTROL_encoder_pin_a           33 // pin encoder b
  #define _LCDML_CONTROL_encoder_pin_b           31 // pin encoder a
  #define _LCDML_CONTROL_encoder_pin_button      35 // pin taster
